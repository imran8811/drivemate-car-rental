...
import { IRent, Rent } from './rent.model';
...
import { IBookingStatusesModel } from './bookingStatuses.model';
import { IPaymentReceipt } from '../airport-transfer-booking';

export interface IBookingDataModel {
  _assetId: string;
...
export class BookingDataModel implements IBookingDataModel {
  '_assetId' = '';
  '_assetOwnerId' = '';
  '_invoiceId': string;
  '_memberId': string;
